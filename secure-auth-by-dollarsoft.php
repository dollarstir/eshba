...
<html>
<head>
        <title>Veification | Eshba Logisitics</title>
        <meta charset="UTF-8">
...
<!--sign up panel-->
            <div class="modal-content">   
                <div class="login-wrap text-center">                        
                    <h2 class="title-3"> Verification Code </h2>
                    <?php 

                        $dollarsoftcoded= $_GET['dollarsoftauthcoded'];
                    ...
                    <div class="login-form clrbg-before">
                        <form class="login" id="verifrm">
                            <div class="form-group"><input type="text"  style="color:black;text-transform:none;" placeholder="Enter verification code sent to your email" name="vcode" class="form-control"></div>
                            <div class="form-group"><input type="hidden"  style="color:black;" placeholder="enter verification code sent to your email" name="dollarsoftcoded" class="form-control" value="<?php echo$dollarsoftcoded;?> "></div>
                        ...
                        <a href="password-recovery.php" class="gray-clr"> Didn't get code? <button class="fs-12 black-bg" type="submit"> Resend </button>  </a>   
